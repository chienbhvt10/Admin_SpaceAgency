...
export type IDocumentRequest = {
  __typename: 'DocumentRequest';
  id: string;
  documentType: DocumentType;
  requesterFullName: string;
  furigana: string;
  age?: DocumentRequestAge | null;
  address: string;
  tel: string;
  question?: string | null;
  email: string;
  desiredContactMethod?: DesiredContactMethod | null;
  currentHouseType?: CurrentHouseType | null;
  hasLand?: boolean | null;
  desiredDeploymentTime?: DesiredDeploymentTime | null;
